          ...
          <div className="mx-auto mt-10 grid gap-5 lg:grid-cols-[0.58fr_0.42fr]">
            ...
            <aside className="rounded-[2rem] border border-viz-100 bg-white p-6 text-left shadow-soft sm:p-8">
              ...
              <div className="mt-6 space-y-3">
                ...
                <button type="button" className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl px-4 text-sm font-black text-slate-500 transition hover:bg-viz-50 hover:text-viz-700">
