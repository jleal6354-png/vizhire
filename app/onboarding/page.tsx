            ...
            <section id="resume" className="glass scroll-mt-24 rounded-3xl p-5 sm:p-8">
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-dashed border-viz-300 bg-white p-5">
                  ...
                  <ComingSoonButton className="mt-4 min-h-12 w-full rounded-xl border border-viz-300 px-4 py-3 text-sm font-black text-viz-700 sm:w-auto" title="Resume upload" message="Resume upload is coming soon. This prototype shows the guided experience and extracted work history flow.">Upload resume</ComingSoonButton>
                </div>
