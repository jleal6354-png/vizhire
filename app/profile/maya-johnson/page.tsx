      ...
      <header className="border-b border-viz-100 bg-white/88 px-4 py-4 backdrop-blur">
        <nav className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button className="hidden items-center gap-2 rounded-xl bg-viz-700 px-4 py-3 text-sm font-black text-white sm:inline-flex">
        ...
        <div className="space-y-6">
          <div className="glass rounded-3xl p-5 sm:p-8">
            <div className="grid items-center gap-6 md:grid-cols-[auto_1fr]">
              <img src={candidate.avatar} alt={candidate.name} className="h-32 w-32 rounded-3xl object-cover shadow-soft" />
              <div>
        ...
        <aside className="space-y-6">
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <div className="mt-5 space-y-3">
              ...
              <button className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-viz-200 bg-white px-4 py-3 font-black text-viz-700"><Link2 className="h-4 w-4" /> Copy Link</button>
            </div>
          </div>
          <div className="glass rounded-2xl p-6">
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <div className="mt-4 space-y-3">
              {candidate.portfolio.map((item) => (
                <Link key={item} href="#" className="block rounded-xl bg-viz-50 px-4 py-3 text-sm font-black text-viz-700">{item}</Link>
              ))}
            </div>
          </div>
        </aside>
