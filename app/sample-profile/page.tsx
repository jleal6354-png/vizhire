      ...
      <section className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-6 rounded-3xl border border-viz-100 bg-gradient-to-r from-viz-50 via-white to-viz-50 p-5 shadow-soft">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link href="/candidate-signup" className="inline-flex min-h-12 items-center justify-center rounded-xl bg-viz-700 px-5 font-black text-white shadow-glow">
              Create My Free Profile
            </Link>
          </div>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.72fr_0.28fr]">
          ...
          <aside className="space-y-6">
            <div className="glass rounded-2xl p-6">
              ...
              <Link href="/candidate-signup" className="mt-5 inline-flex w-full min-h-12 items-center justify-center rounded-xl bg-viz-700 px-4 font-black text-white shadow-glow">
                Create My Free Profile
              </Link>
            </div>
            <div className="glass rounded-2xl p-6">
