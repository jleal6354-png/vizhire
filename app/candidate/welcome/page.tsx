          ...
          <div className="space-y-5">
            <div className="glass overflow-hidden rounded-[2rem] p-4">
              <div className="relative overflow-hidden rounded-3xl">
                <img src={candidate.video} alt={`${candidate.name} video introduction`} className="h-[520px] w-full object-cover" />
                ...
                <button className="absolute inset-0 m-auto grid h-16 w-16 place-items-center rounded-full bg-white text-viz-700 shadow-soft" aria-label={`Play ${candidate.name} intro`}>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <h2 className="mt-2 text-4xl font-black">{candidate.name}</h2>
                  <p className="mt-2 font-bold text-white/82">{candidate.title} · {candidate.location}</p>
                  <p className="mt-4 max-w-2xl text-sm leading-6 text-white/76">{candidate.summary}</p>
                </div>
              </div>
            </div>
