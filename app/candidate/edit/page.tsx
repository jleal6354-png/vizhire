        ...
        <form className="grid gap-6 lg:grid-cols-[0.62fr_0.38fr]">
          ...
          <section className="space-y-4">
            <div className="rounded-2xl border border-dashed border-viz-300 bg-white p-5">
              ...
              <ComingSoonButton className="mt-4 min-h-12 w-full rounded-xl border border-viz-300 px-4 py-3 text-sm font-black text-viz-700" title="Resume upload" message="Resume upload is coming soon. This prototype already shows how extracted experience will appear.">Upload resume</ComingSoonButton>
            </div>
          </section>
          ...
          <section className="glass rounded-3xl p-5 sm:p-6 lg:col-span-2">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <ComingSoonButton className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl border border-viz-200 bg-white px-4 py-3 text-sm font-black text-viz-700 sm:w-fit" title="Resume scan" message="Resume re-scan is coming soon. This will refresh extracted roles, companies, and experience details.">
