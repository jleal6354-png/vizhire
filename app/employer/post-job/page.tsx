...
import { ArrowRight, BarChart3, BriefcaseBusiness, CalendarDays, EyeOff, Lightbulb, MapPin, MessageCircle, Play, Rocket, Sparkles, UsersRound, Video } from "lucide-react";
      ...
      <div className="grid gap-6 xl:grid-cols-[0.58fr_0.42fr]">
        ...
        <section className="space-y-4">
          <div className="glass rounded-3xl p-6">
            ...
            <Link href={`/employer/jobs/${jobs[0].id}/promote`} className="vh-btn vh-btn-primary vh-btn-lg mt-5 w-full">
              <Rocket className="h-5 w-5" />
              <span>Promote this role</span>
