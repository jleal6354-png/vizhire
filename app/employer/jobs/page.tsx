              ...
              <article key={job.id} className="rounded-3xl border border-viz-100 bg-white p-5 shadow-soft transition hover:-translate-y-0.5 hover:shadow-glow">
                <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2 lg:w-80">
                    ...
                    <ComingSoonButton
                      className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-viz-100 bg-white px-4 text-sm font-black text-slate-600"
                      title="Pause job"
                      message="Use the job detail status control to pause, fill, close, or reopen a posting. This quick action will update the job from the list soon."
                    >
