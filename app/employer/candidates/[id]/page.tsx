        ...
        <section className="space-y-6">
          <div className="glass rounded-3xl p-6">
            <div className="grid items-center gap-5 sm:grid-cols-[auto_1fr_auto]">
              <img src={candidate.avatar} alt={candidate.name} className="h-24 w-24 rounded-3xl object-cover" />
              <div>
              ...
              <div className="flex gap-2">
                <button className="rounded-xl border border-viz-200 bg-white p-3 text-viz-700"><Share2 className="h-5 w-5" /></button>
                <button className="rounded-xl bg-viz-700 px-4 py-3 text-sm font-black text-white">Shortlist</button>
              </div>
            </div>
          </div>
          ...
          <section className="glass rounded-2xl p-6">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              ...
              <button className="inline-flex w-fit items-center justify-center gap-2 rounded-xl border border-viz-200 bg-white px-4 py-3 text-sm font-black text-viz-700">
        ...
        <aside className="space-y-6">
          <div className="glass rounded-2xl p-6">
            ...
            <div className="mt-5 space-y-3">
              <button className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-viz-700 px-4 py-3 font-black text-white"><Mail className="h-4 w-4" /> Contact Candidate</button>
              <button className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-viz-200 bg-white px-4 py-3 font-black text-viz-700"><Download className="h-4 w-4" /> View Resume</button>
            </div>
          </div>
          <ShareActions
            employerMode
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <button className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-viz-300 px-4 py-3 font-black text-viz-700">
