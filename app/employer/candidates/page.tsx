    ...
    <AppShell title="Browse Candidates" subtitle="Explore available professionals, save promising people, and open deeper review when someone stands out.">
      <div className="space-y-5">
              ...
              {industries.map((industry) => (
                <button
                  ...
                  className={`shrink-0 rounded-full px-4 py-2 text-xs font-black transition ${
                    selectedIndustry === industry ? "bg-viz-700 text-white shadow-glow" : "bg-white text-viz-700 ring-1 ring-viz-100 hover:bg-viz-50"
                  }`}
                >
                  {industry}
                </button>
              ))}
              <button className="inline-flex shrink-0 items-center gap-2 rounded-full bg-white px-4 py-2 text-xs font-black text-viz-700 shadow-soft">
        ...
        <section className="space-y-5">
          <div className="rounded-3xl border border-viz-100 bg-white p-4 shadow-soft sm:p-5">
