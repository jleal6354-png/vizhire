          ...
          <div className="flex h-full items-center justify-center">
            <div className="w-full max-w-xl rounded-[2rem] border border-viz-100 bg-white p-6 shadow-soft sm:p-8 lg:p-10">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <button className="inline-flex min-h-13 items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 font-bold text-ink transition hover:border-viz-300 hover:bg-viz-50">
