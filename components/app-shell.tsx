        ...
        <header className="sticky top-0 z-20 border-b border-viz-100 bg-white/88 px-4 py-4 backdrop-blur lg:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex flex-1 items-center justify-end gap-3">
              ...
              <ComingSoonButton
                className="relative rounded-full border border-viz-100 bg-white p-3 shadow-soft"
                ariaLabel="Notifications"
                title="Notifications"
                message="Notifications are coming soon. This will show application updates, candidate activity, and hiring alerts."
              >
